...
def main():
    ...
    # standard convnext hyperparameter optimization 
    def objective(trial):
        # set seed
        ...
        os.makedirs("transfer_convnext_results", exist_ok=True)
        ...
        torch.save(result, f"transfer_convnext_results/transfer_convnext_trial_{trial.number}.pt")
    ...
    storage = "sqlite:///./transfer_convnext.db"
    study_name = "transfer_convnext_hyperparameters_optimization"
