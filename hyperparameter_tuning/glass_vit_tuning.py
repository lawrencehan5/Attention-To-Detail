...
def main():
    ...
    # glass vit hyperparameter optimization 
    def objective(trial):
        # set seed
        ...
        os.makedirs("gl_vit_results", exist_ok=True)
        ...
        # new model instance
        model = GlobalLocalAttentionModel(dropout_rate=dropout_rate, model_type="vit")
        ...
        torch.save(result, f"gl_vit_results/gl_vit_trial_{trial.number}.pt")
    ...
    storage = "sqlite:///./gl_vit.db"
    study_name = "gl_vit_hyperparameters_optimization"
