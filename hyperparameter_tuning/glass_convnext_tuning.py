...
def main():
    ...
    # glass convnext hyperparameter optimization 
    def objective(trial):
        # set seed
        ...
        os.makedirs("gl_convnext_results", exist_ok=True)
        ...
        # new model instance
        model = GlobalLocalAttentionModel(dropout_rate=dropout_rate, model_type="convnext")
        ...
        torch.save(result, f"gl_convnext_results/gl_convnext_trial_{trial.number}.pt")
    ...
    storage = "sqlite:///./gl_convnext.db"
    study_name = "gl_convnext_hyperparameters_optimization"
