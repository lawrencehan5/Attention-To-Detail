...
def main():
    ...
    # standard vit hyperparameter optimization 
    def objective(trial):
        # set seed
        ...
        os.makedirs("transfer_vit_results", exist_ok=True)
        ...
        torch.save(result, f"transfer_vit_results/transfer_vit_trial_{trial.number}.pt")
    ...
    storage = "sqlite:///./transfer_vit.db"
    study_name = "transfer_vit_hyperparameters_optimization"
