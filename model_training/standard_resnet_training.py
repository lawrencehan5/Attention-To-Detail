...
def main():
    ...
    # final standard resnet model training
    all_metrics = []

    best_param = {
        'lr': 4.59049376073978e-05,
        'weight_decay': 3.642553424460737e-07,
        'batch_size': 32,
        'dropout_rate': 0.1
    }
    ...
    for seed in (100, 200, 300, 400, 500):
        ...
        result = train_standard(
            ...
            verbose=True,
            plot = True,
            save = "transfer_resnet"
        )

        torch.save(result, f"transfer_resnet_seed{seed}.pt")

        # load best epoch
        model.load_state_dict(torch.load(f"transfer_resnet.pt"))
