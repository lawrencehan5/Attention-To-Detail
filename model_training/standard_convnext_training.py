...
def main():
    ...
    # final standard convnext model training
    all_metrics = []

    best_param = {
        'lr': 7.124161487066723e-05,
        'weight_decay': 2.1340317671998637e-06,
        'batch_size': 128,
        'dropout_rate': 0.1
    }
    ...
    for seed in (100, 200, 300, 400, 500):
        ...
        result = train_standard(
            ...
            verbose=True,
            plot = True,
            save = "transfer_convnext"
        )

        torch.save(result, f"transfer_convnext_seed{seed}.pt")

        # load best epoch
        model.load_state_dict(torch.load(f"transfer_convnext.pt"))
