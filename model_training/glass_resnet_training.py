...
def main():
    ...
    # final glass resnet model training
    all_metrics = []

    best_param = {
        'batch_size': 32,
        'dropout_rate': 0.3,
        'lr_global': 2.158777650700252e-06,
        'lr_local': 6.853800121248665e-05,
        'lr_atten_class': 2.979509550261194e-05,
        'wd_global': 1.7932951228672164e-07,
        'wd_local': 6.017513558414679e-07,
        'num_crops': 6
    }
    ...
    for seed in (100, 200, 300, 400, 500):
        ...
        model = GlobalLocalAttentionModel(dropout_rate=best_param['dropout_rate'], model_type="resnet")
        ...
        # save results
        torch.save(result, f"gl_resnet_seed{seed}.pt")

        # load best epoch
        model.load_state_dict(torch.load(f"gl_resnet.pt"))
